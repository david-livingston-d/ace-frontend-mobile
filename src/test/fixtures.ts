...
export function deliveryNoteDetail(over: Partial<Schemas['DeliveryNoteDetailOut']> = {}): Schemas['DeliveryNoteDetailOut'] {
  return {
    id: 'dn1',
    number: 'DN-26-27-000007',
    so_id: 'o1',
    so_number: 'POS-26-27-000041',
    so_phase: 'partially_reserved',
    customer_id: 'c1',
    customer_name: 'Arjun Mehta',
    customer_gstin: null,
    place_of_supply_state: 'TN',
    ...
    warehouse_id: 'w1',
    warehouse_name: 'Main warehouse',
    dispatch_warehouse_id: null,
    dispatch_warehouse_name: null,
    dn_date: '2026-08-15',
    status: 'draft',
    transport: {
      transporter_id: null,
    ...
    packing: { packages_count: null, gross_weight_kg: null, packing_marks: null },
    received_by: null,
    remarks: null,
    gross: '19960.00',
    line_discount: '0.00',
...
export function invoiceDetail(over: Partial<Schemas['InvoiceDetailOut']> = {}): Schemas['InvoiceDetailOut'] {
  return {
    id: 'inv1',
    number: 'INV-26-27-000007',
    so_id: 'o1',
    so_number: 'POS-26-27-000041',
    so_phase: 'fully_delivered',
    customer_id: 'c1',
    customer_name: 'Arjun Mehta',
    customer_gstin: null,
    billing_address: {},
    ...
    igst: '0.00',
    tax: '998.00',
    net_before_round: '20958.00',
    round_off: '0.00',
    net: '20958.00',
    qty_total: '8',
    paid_amount: '0.00',
    outstanding: '20958.00',
    is_overdue: false,
    einvoice: {
...
export function invoiceableItem(
  over: Partial<Schemas['InvoiceableItemOut']> = {},
): Schemas['InvoiceableItemOut'] {
  return {
    dn_id: 'dn1',
    number: 'DN-26-27-000007',
    delivered_on: '2026-08-16',
...
export function invoiceable(over: Partial<Schemas['InvoiceableOut']> = {}): Schemas['InvoiceableOut'] {
  const items = over.items ?? [invoiceableItem()];
  return { items, total: items.length, ...over };
}
