...
import type { CustomerTypeOut, PaymentTermOut, CategoryOut, DepartmentOut } from '@/lib/api/types';
...
export const mastersApi = {
  ...
  departments: () => api.get<ListEnvelope<DepartmentOut>>('/departments').then((r) => r.data),
};
