 ...
 * payment the server last returned. CONTINUE is greyed out with a plain-English
 * hint (`permissionHint`, never the raw permission code) rather than hidden
 * when the viewer can't drive the next step — a rep without `payment.allocate`
 * still sees that allocation is what comes next, just not the button for it. */
